class RecipeSerializer < ActiveModel::Serializer
  ...
  delegate :benefits_to_brain_health, :card_image, :card_title, :description,
           ...
           :recommend_percentage, :section1_body, :title,
           to: :common
  ...
  attributes :benefits_to_brain_health, :card_image, :card_title, :description,
             ...
             :mast_head_title, :recommend_percentage, :section1_body, :slug,
             :source_materials_citation, :path_pillar, :path_year, :keywords,
