const sitemapUrls = function ($state) {
  'ngInject';

  const urlObjectArray = (extraStopWords = []) => {
    ...
    return _.sortBy(urls, urlData => urlData.title);
  };

  return {
    urlObjectArray: urlObjectArray,
  };
};
